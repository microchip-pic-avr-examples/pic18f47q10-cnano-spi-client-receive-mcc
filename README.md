...
2. Open the *pic18f47q10-cnano-spi-client-receive-mcc.X* project in MPLAB® X IDE.

3. Set *pic18f47q10-cnano-spi-client-receive-mcc.X* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*.
...
## Summary
This project is an illustration for a basic use case based around MSSP in SPI mode.
